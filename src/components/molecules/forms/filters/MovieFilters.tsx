...
import {fetchFilteredMovies} from "../../../../redux/slices/movie-slice";
...
const MovieFilters: React.FC = () => {
    ...
    const handleFilter = () => {
        ...
        dispatch(fetchFilteredMovies({ params: cleanedFilters, page: 0, size: 10 }))
    }
    ...
    const handleClearFilters = () => {
        ...
        dispatch(fetchFilteredMovies({ params: {}, page: 0, size: 10 }));
    };
