...
import {selectInterestedMovies} from "../../../../redux/slices/movie-slice";
import MovieCard from "../../../molecules/cards/MovieCard";
import {FontAwesomeIcon} from "@fortawesome/react-fontawesome";
import {faArrowLeft, faArrowRight} from "@fortawesome/free-solid-svg-icons";

const InterestedMovies: React.FC = () => {
    const interested = useSelector(selectInterestedMovies)
    ...
    return (
        <div className="mt-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {interested?.slice(currentPage * 4, (currentPage + 1) * 4).map(movie => (
